...
if($_SESSION['LoginId']=="" && $_SESSION['PassCode']=="" && $_SESSION['Level']=="" && !$_SESSION['Level']=="Admin")
{
...
<title>CPanel</title>
<body topmargin="0" leftmargin="0" background="images/bgGray.png">
				...
				<?php }?>
                         <tr>
                           <td width="100%">
                            ...
                            }else  if(isset($_GET['gotoA'])){
                            include $_GET['gotoA'].".php";
                            }else{
                            include "body.php";
                            }
                            ?></td>
